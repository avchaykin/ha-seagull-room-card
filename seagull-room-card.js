...
class SeagullRoomCard extends HTMLElement {
  ...
  _buildLightsHtmlAndItems() {
    ...
    const renderButton = (item, index, opts = {}) => {
      ...
      const gaugeBg = this._paletteColor(this._resolveDynamicValue(gaugeCfg?.background, item.entity, state, "rgba(255,255,255,0.18)"));
